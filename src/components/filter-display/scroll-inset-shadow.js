...
const pokemonLeftshadow = pokemonFilter.querySelector('.scroll-inset-shadow-left');
const pokemonRightshadow = pokemonFilter.querySelector('.scroll-inset-shadow-right');
...
const speciesLeftshadow = speciesFilter.querySelector('.scroll-inset-shadow-left');
const speciesRightshadow = speciesFilter.querySelector('.scroll-inset-shadow-right');
...
function setupScrollShadowEffect(scrollWrapper, shadowLeft, shadowRight) {
  ...
  } else if (scrollWrapper.scrollLeft + scrollWrapper.clientWidth === scrollWrapper.scrollWidth) {
    shadowLeft.classList.toggle('shadow-invisible', isHidden);
    shadowRight.classList.toggle('shadow-invisible', !isHidden);
  } else {
...
pokemonScrollWrapper.addEventListener('scroll', () => {
  setupScrollShadowEffect(pokemonScrollWrapper, pokemonLeftshadow, pokemonRightshadow);
});

speciesScrollWrapper.addEventListener('scroll', () => {
  setupScrollShadowEffect(speciesScrollWrapper, speciesLeftshadow, speciesRightshadow);
});
